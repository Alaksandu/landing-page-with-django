# Generated by Django 3.2.13 on 2022-05-08 15:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-rocket', 'Foguete'), ('lni-laptop-phone', 'Responsividade'), ('lni-cog', 'Engrenagem'), ('lni-leaf', 'Folha'), ('lni-layers', 'Design')], max_length=30, verbose_name='Icone')),
            ],
            options={
